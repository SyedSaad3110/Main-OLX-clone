  ...
  return (
    ...
    <InnerCardSection>
        ...
        <div className="left_container">
            <div className="box">
              ...
              <img src="https://images.olx.com.pk/thumbnails/380566697-400x300.webp" alt="" />
              </div>
    ...
    <div className="inner_container">
        <div className="inner_cards">
          <img src="https://images.olx.com.pk/thumbnails/485791171-240x180.webp" alt="" />
        </div>
       ...
       <div className="sec_container">
        ...
        <div className="text">
        <h4>Vivo Y17 | LCD 6.35 - Full View Display | 5000 MAh Battery Dual Sim</h4>
        </div>

        <div className="country">
        <div className="lo_name">
        <i class="fa-solid fa-location-dot" ></i>
        <p>Safoora Goth, Karachi</p>
        </div>
        <div className="week">
          <p>2 week ago</p>
        </div>
       ...
       <div className="four_container">
        ...
        <div className="tex">
          <p className='first'>Vivo Y17 | 8/256 - Dual Sim | Pta Approved </p>
