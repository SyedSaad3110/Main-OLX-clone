...
function Navbar() {
      ...
      const [showLocationPlaceholder, setShowLocationPlaceholder] = useState(true);
    ...
    //  const [locationplaceHolder, setLocationPlaceHolder] =  useState("Pakistan")
    //  const [searchplaceHolder, setSearchPlaceHolder] =  useState("'Find Cars , Mobile Phones and more...'")

    //   const handlerChanger = ()=>{
    //      setLocationPlaceHolder("Location or Compound")
    //   }
  ...
  return (
    ...
    {/* <div className="login_container">
        <div className="login_page">
          ...
          <div className="logo_name">
        <a href="#"><h2>O<span>|</span>X</h2></a>
        <h6>Login into your OLX account</h6>
        </div>
        </div>
    </div>
       */}
      ...
      <div className="sec_container" >
        <div className="location_placeholder">
            ...
            placeholder={showLocationPlaceholder ? "Pakistan" : ""}
        ...
        <div className="search_placeholder">
            ...
            //  onChange={searchHandler} 
             type="text"
             placeholder={showPlaceholder ? "Find Cars , Mobile Phones and more..." : ""}
             value={inputValue}
            ...
            //   onBlur={(e) => e.target.placeholder = 'cars and bikes'}
                />
            <i class="fa-solid fa-magnifying-glass"></i>
        </div>
        <div className="login_name">
            <a className='a_logos' href="#"><h4>Login</h4></a>
